    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md rounded-3xl border-2 border-foreground bg-white p-8 shadow-[0_6px_0_0_hsl(0_0%_0%)]">
        ...
        <div className="text-center">
          <h2 className="font-bricolage text-3xl font-black">Welcome back</h2>
          <p className="mt-2 text-sm text-foreground/70">Sign in to continue your technical interview.</p>
        </div>
